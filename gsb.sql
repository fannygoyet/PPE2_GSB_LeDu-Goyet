...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 14 mai 2020 à 21:42
...
(99, 'LE DU', 'Kilian', 'Vers là-bas', '93270', 'Redon City', 999, 'ABC');
...
('waw', 5, 81, '2019-03-17 00:00:00', 'Je n\'sais pas.', 'Je n\'sais pas'),
('c23', 1, 123, '2020-05-14 20:23:00', 'test', 'test'),
('c23', 2, 123, '2020-05-14 20:30:21', 'test', 'test'),
('c23', 3, 123, '2020-05-14 20:30:33', 'test', 'test'),
('c23', 4, 123, '2020-05-14 20:30:56', 'test', 'test');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `level` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
(1, 'Test', '0', 't@t.t', NULL, '$2y$10$/shfow/0j8u7iRYDG1Z8delW85oTo5YV7AU/y3ZqpjMKQ80dWGs4K', NULL, '2019-11-06 17:17:27', '2019-11-06 17:17:27'),
(2, 'Patate', '0', 'Patate@patate.fr', NULL, '$2y$10$/shfow/0j8u7iRYDG1Z8delW85oTo5YV7AU/y3ZqpjMKQ80dWGs4K', NULL, '2019-11-06 17:23:45', '2019-11-06 17:23:45'),
(3, 'Lefebvre', '11', 'Lefebvre.Bertrand@Adresse.fr', NULL, '$2y$10$NVCYfGFVC0HGjr5PPE4c7OgkV7njyC3CCcFPBhV8uYQOoYkPCKaQe', NULL, '2019-11-06 17:50:18', '2019-11-06 17:50:18'),
(4, 'Souron', 't43', 'Souron.Maryse@Adresse.fr', NULL, '$2y$10$NVCYfGFVC0HGjr5PPE4c7OgkV7njyC3CCcFPBhV8uYQOoYkPCKaQe', NULL, '2019-11-06 17:58:01', '2019-11-06 17:58:01'),
(5, 'qsdjkqlsdjk', '0', 'dqsldkj@qsdkjqlsd', NULL, '$2y$10$triOo.mf..pk/4O5kQMlD.3KFgg50ctCr01ygc2mz.SQyUx5TJclK', NULL, '2019-11-06 18:00:34', '2019-11-06 18:00:34'),
(6, 'Admin', '0', 'Admin@Saucisse.fr', NULL, '$2y$10$nEUXJrByDyTbyhjKHv3GH.322D1AOR2VZ.dm3l0rIJuIhX4yzMCoG', NULL, '2019-11-07 19:41:17', '2019-11-07 19:41:17');
...
CREATE TABLE IF NOT EXISTS `visiteur` (
  ...
  `VIS_DATEEMBAUCHE` varchar(20) DEFAULT NULL,
...
('a131', 'Vil', 'Lo', '8 cours Lafonta', '000', 'BRE', '1992-12-11 00:00:00', NULL, 'SW'),
('a17', 'Andre', 'David', '1 r Aimon de Chissée', '38100', 'GRENOBLE', '1991-08-26', NULL, 'GY'),
...
('waw', 'LEDU', 'Kilian', '9 rue de la barre', '35600', 'REDON', 'debug', '1', '12');
COMMIT;
